...
import { FaSpinner, FaUtensils, FaShoppingCart, FaClipboardList, FaUser } from 'react-icons/fa';
...
export default function CustomerPageContent() {
  ...
  // Handle SSR - searchParams may be null during prerender
  const qrParam = searchParams?.get('q') || searchParams?.get('qr') || '';
        ...
        {showCustomerInfoModal && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 max-w-lg mx-auto bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 rounded-t-[2rem] z-[151] shadow-2xl p-6 max-h-[90vh] overflow-y-auto will-change-transform border-t border-white/10"
            >
              {/* Drag Handle */}
              ...
              <div className="space-y-5">
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800/50 border-2 border-slate-700/50 rounded-2xl pl-5 pr-5 py-4 focus:border-indigo-500 focus:bg-slate-800 outline-none transition-all font-medium text-lg text-white placeholder:text-slate-500"
                  />
                  {infoErrors.customerName && <p className="text-rose-500 text-xs mt-1 ml-1 font-bold">{infoErrors.customerName.message}</p>}
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 text-center bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border-2 border-indigo-500/30 rounded-2xl py-4">
                      <span className="text-3xl font-black text-white">{infoData.numberOfPersons}</span>
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-800/50 border-2 border-slate-700/50 rounded-2xl pl-5 pr-5 py-4 focus:border-indigo-500 focus:bg-slate-800 outline-none transition-all font-medium text-lg text-white placeholder:text-slate-500"
                  />
                  {infoErrors.customerPhone && <p className="text-rose-500 text-xs mt-1 ml-1 font-bold">{infoErrors.customerPhone.message}</p>}
                </div>
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-4 rounded-2xl font-black uppercase text-sm tracking-[0.25em] hover:from-indigo-700 hover:to-purple-700 transition-all shadow-xl shadow-indigo-600/30 active:scale-[0.98]"
                >
                  Start Experience
                </button>
              </div>
