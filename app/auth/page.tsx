...
function AuthPageContent() {
    ...
    const handleGoogleSignIn = () => {
        if (googleAuthClient) {
            ...
            console.error('Google Sign-In is initializing...');
        }
    };
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-800 via-slate-900 to-indigo-900 relative overflow-hidden flex items-center justify-center p-4">
            ...
            <div className="relative z-10 w-full max-w-max">
                <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-6 md:p-8 border border-white/20">
                    ...
                    {/* Premium Custom Google Sign In Button */}
                    <motion.div 
                    ...
                    >
                        <button
                            ...
                            className="w-full bg-white hover:bg-slate-50 text-slate-700 font-semibold py-3 px-4 rounded-xl border border-slate-200 shadow-sm transition-all duration-300 flex items-center justify-center gap-3 active:scale-[0.98] group disabled:opacity-70 disabled:cursor-not-allowed"
                            type="button"
                        >
                            {isGoogleLoading ? (
                                ...
                                <>
                                    ...
                                    <span className="text-sm tracking-tight font-medium">Continue with Google</span>
                                </>
                            )}
                        </button>
                    </motion.div>
