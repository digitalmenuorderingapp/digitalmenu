...
export const TRANSLATIONS = {
  en: {
    ...
    offer_desc_p2: "Experience the full power for 90 days. Then, a minimal ₹2000/year plan applies.",
    offer_cta: "Start Trial",
    offer_learn: "Why only ₹2000/year?",
    ...
    offer_limit: "Note: After 3 months of free trial, a minimal ₹2000/yearly plan applies to keep the platform sustainable.",
    ...
    why_affordable_body3: "Your ₹2000/year directly fuels server maintenance, security updates, and new feature development. It's not a cost; it's an investment in your restaurant's digital future.",
    sub_payment_manual: "Manual Activation Required",
    sub_payment_desc: "1. Pay ₹2000/year via QR/Bank.\n2. Send Screenshot + Restaurant ID to WhatsApp/Email.",
  ...
  hi: {
    ...
    offer_desc_p2: "90 दिनों तक पूरी पावर का अनुभव करें। उसके बाद, केवल ₹2000/साल का छोटा चार्ज।",
    offer_cta: "परीक्षण शुरू करें",
    offer_learn: "₹2000/साल क्यों?",
    ...
    offer_limit: "नोट: 3 महीने के फ्री ट्रायल के बाद, प्लेटफॉर्म को बेहतर बनाए रखने के लिए ₹2000/सालाना का छोटा प्लान लागू होगा।",
    ...
    why_free_body3: "इस प्लेटफॉर्म को तेज़, सुरक्षित और अपडेटेड रखने के लिए, हम ट्रायल के बाद ₹2000/साल का मामूली शुल्क लेते हैं। यह हमारे सर्वर खर्चों को पूरा करता है और टूल को सभी के लिए सुलभ रखता है।",
    sub_payment_manual: "मैनुअल एक्टिवेशन जरूरी",
    sub_payment_desc: "1. QR/बैंक के माध्यम से ₹2000/साल का भुगतान करें।\n2. व्हाट्सएप/ईमेल पर स्क्रीनशॉट + रेस्टोरेंट ID भेजें।",
  ...
  bn: {
    ...
    offer_desc_p2: "৯০ দিনের জন্য সব ফিচার ব্যবহার করুন। এরপর বছরে মাত্র ২০০০ টাকার ছোট প্ল্যান।",
    offer_cta: "ট্রায়াল শুরু করুন",
    offer_learn: "বছরে মাত্র ২০০০ টাকা কেন?",
    ...
    offer_limit: "দ্রষ্টব্য: ৩ মাসের ফ্রি ট্রায়ালের পর, প্ল্যাটফর্মটি বজায় রাখার জন্য বছরে মাত্র ২০০০ টাকার প্ল্যান কার্যকর হবে।",
    ...
    why_affordable_body3: "আপনার বছরে ২০০০ টাকা সরাসরি সার্ভার রক্ষণাবেক্ষণ, সুরক্ষা আপডেট এবং নতুন ফিচার তৈরিতে ব্যবহৃত হয়। এটি কেবল খরচ নয়; এটি আপনার রেস্তোরাঁর ডিজিটাল ভবিষ্যতে একটি বিনিয়োগ।",
    sub_payment_manual: "ম্যানুয়াল অ্যাক্টিভেশন প্রয়োজন",
    sub_payment_desc: "১. কিউআর/ব্যাংকের মাধ্যমে বছরে ২০০০ টাকা পেমেন্ট করুন।\n২. হোয়াটসঅ্যাপ/ইমেইলে পেমেন্ট স্ক্রিনশট + রেস্টুরেন্ট ID পাঠান।",
